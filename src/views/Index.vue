...
<template>
  <div
    ...
    class="bg-no-repeat bg-center bg-cover w-screen h-screen min-w-[1366px] min-h-[768px] flex justify-center"
  >
    <div class="mt-10 w-100 2xl:w-120">
      <div class="flex">
        <img class="grow" :src="center" />
      </div>
